...
message3 = tk.Label(window, text="Attendify:ai powered Face Recognition  Attendance" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
def send_email():
    ...
    from_email = "ragulasoumya5@gmail.com"  # Replace with your email
    password = "ymmh rsjx urnk dvrt"  # Replace with your app password
    ...
    if not os.path.exists(filename):
        mess._show(title='Error', message=f"Attendance file not found: {filename}")
        return
    ...
    try:
        ...
        mess._show(title='Error', message=f"Failed to attach file: {e}")
        return
    ...
    try:
        ...
        mess._show(title='Error', message='Authentication failed. Check your email and password.')
    except Exception as e:
